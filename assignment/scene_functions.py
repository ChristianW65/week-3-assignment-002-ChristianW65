...
def create_building(width=4, height=8, depth=4, position=(0, 0, 0)):
    ...
    # Offset Y by half the height so the base sits on the ground
    cmds.move(
        position[0],
...
def create_tree(trunk_radius=0.3, trunk_height=3, canopy_radius=2,
    ...
    """
    # Trunk — centre it so its base sits at y=0
    ...
    # Group and move to final position
